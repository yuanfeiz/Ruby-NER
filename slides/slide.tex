...
\begin{frame}{Sample Training Data}
	\begin{figure}[h]
		\centering
		\includegraphics[height=0.6\textheight]{./figures/traindata.png}
...
We are still keep polishing our models and conducting further experiments, hence the results presented here are not our final version.
...
\begin{tabular}{|c|c|c|}
	...
	+POS & 79.02 & 81.95 \\
	\hline
	+Pre/Suffix & 85.99 & \textbf{88.89} \\
	\hline
	+Surname List & \textbf{86.53} & 88.70 \\
	\hline
	+Gazetteer & Not Ready & Not Ready \\
	\hline
	+mkcls & Not Ready & Not Ready \\
	\hline
\end{tabular}}
...
\begin{enumerate}
	\item LOCATION is a relatively easier task under our word-based system
		\pause
	\item PERSON has the lowest accuracy.
		\pause
		\begin{itemize}
			\item A character based system is more suitable for Chinese person name recognition. \pause
			\item Pre/Suffix and Gazetteers incurred great improvement in PERSON task. \pause
		\end{itemize}
